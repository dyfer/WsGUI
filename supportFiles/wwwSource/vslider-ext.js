...
$.widget("mobile.slider", $.mobile.slider, {
    ...
    _create: function() {
	    ...
	    // slider.insertAfter( control );//moved lower
	    ...
	    this.slider.attr("style", "width:100% !important; margin: 0 0 0 0 !important; height:100% !important;")
	    this.handle.attr("style", "height:10% !important; left:-10%; min-height: 30px; width: 120%; margin: 0 0 -5% 0")
            // $(this.control).detach()
            // $(this.slider).parent().append(this.control)
            // $(this.slider).parent().css("margin-bottom", (this.options.height + 30) + "px")
	    // $(this.slider).parent().css("margin-bottom", (this.options.height + 30) + "px")

	    // slider.insertAfter( control ); //Marcin moved it here - to avoid problems with addressing 
        } else {
            this._super()
        }
    },
